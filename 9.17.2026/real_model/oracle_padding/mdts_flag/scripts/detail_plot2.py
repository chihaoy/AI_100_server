...
def cat(r):
    ...
    if n.startswith('to_g_'): return 'tc_gather'
    if n.startswith('to_partials'): return 'lane_reduce'
    if n.startswith('to_'): return 'tc_mask_add'
    ...
    if n.startswith('final_tile_') or n == 'Einsum_4' or n.startswith('final_slice_') or n.startswith('rs_'): return 'card_reduce'
